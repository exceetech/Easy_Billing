...
class InvoiceActivity : AppCompatActivity() {
    ...
    private fun recalculate() {
        ...
        bindTaxTile(rowCgst, tvCgstLabel, tvCgstAmount, tvCgstRate, cgstOn, breakdown.totalCgst, breakdown.subtotal)
        bindTaxTile(rowSgst, tvSgstLabel, tvSgstAmount, tvSgstRate, sgstOn, breakdown.totalSgst, breakdown.subtotal)
        bindTaxTile(rowIgst, tvIgstLabel, tvIgstAmount, tvIgstRate, igstOn, breakdown.totalIgst, breakdown.subtotal)
    ...
    private fun saveBill() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                // Round-off (floor) folded into the discount so the payable
                // lands on a whole rupee without touching GST/other logic.
                val roundOff = roundOffAmount(breakdown.grandTotal - userDiscount)
                val discount = userDiscount + roundOff
